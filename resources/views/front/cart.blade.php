...
<div class="row">
    <div class="col-7">
        <div class="card">
            ...
            @if(count($carts) > 0)
                ...
                <div class="card-body">
                    ...
                    <div class="col-8">
                        ...
                        <button onclick="confirm('Tenane??')" class="btn btn-sm btn-danger">
            ...
            @else
            <div class="card-body">
            <h4><b>KOSONG?!</b> Astagfirullah haladzim! </h4>
            </div>
            @endif
        </div>
    </div>
    <div class="col-5">
        <div class="card" style="padding:25px;">
            <h4>Totalan Bos : {{idrFormat($total)}}</h4>
            <form method="POST" action="{{url('cart/checkout')}}">
                @csrf
                <button class="btn btn-sm btn-success" style="width:100%;margin-top:100px;">Sat Set Bayar!</button>
            </form>
        </div>
    </div>
</div>
